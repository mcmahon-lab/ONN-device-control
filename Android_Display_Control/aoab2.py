...
# aoab2 written by Brian Richard (bcr53), but mostly adopted from the below example on GitHub
# To be used with ImageStreamLocal Android app
# sends up to 0xffff bytes of data
